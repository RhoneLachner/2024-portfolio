// app/assets/icons.ts
export const ICONS = {
  chevronLeft: '/images/icons/chevron-left.png',
  chevronRight: '/images/icons/chevron-right.png',

  closeBlack: '/images/icons/close-icon-black.png',
  closeWhite: '/images/icons/close-icon-white.png',
