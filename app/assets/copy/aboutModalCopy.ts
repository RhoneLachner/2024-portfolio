...
export const aboutCopy: AboutCopy = {
  ...
  bio: [
    ...
    `I am a Software Engineer and Product Manager who is passionate about creating meaningful, human-centered technology that reflects the natural world and our shared experience as people. I believe that technology is a reflection of ourselves, nature, and the universe, and I aim to create solutions that are not only functional, but also thoughtful and sustainable.`,
