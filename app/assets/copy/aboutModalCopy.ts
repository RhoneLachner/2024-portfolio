...
export const aboutCopy: AboutCopy = {
  bioImage: '/images/bio-image-2025.webp',
  prefix: [`Hello! `],
  bio: [
    `My name is Sarah-Rhone Lachner, and I usually go by Rhone
    (pronounced like "phone").`,
    `I'm a web developer and musician who is passionate about creating meaningful, human-centered tech that reflects the natural world and our shared experience as people. I believe that technology is a reflection of ourselves, nature, and the universe, and I aim to create thoughtful solutions that are practical, efficient, sustainable, and helpful.`,
